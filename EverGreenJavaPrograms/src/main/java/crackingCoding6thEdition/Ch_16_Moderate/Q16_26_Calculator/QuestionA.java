package crackingCoding6thEdition.Ch_16_Moderate.Q16_26_Calculator;
...
public class QuestionA {
	...
	public static double compute(String sequence) {
		...
		for (int i = 0; i < terms.size(); i++) {
			...
			/* Apply the current term to â€œprocessingâ€�. */
			processing = collapseTerm(processing, current);
			
			/* If next term is + or -, then this cluster is done 
			 * and we should apply â€œprocessingâ€� to â€œresultâ€�. */
